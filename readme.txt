...
Tags: Twenty Thirteen, Custom Colors, Custom, Colors, Theme Customizer, Twenty Thirteen Theme, Default Theme, 2013
Requires at least: 3.6
Tested up to: 4.6
Stable tag: 1.0
Description: Customize the colorscheme of the bold Twenty Thirteen theme, directly within the theme customizer. Also integrates with an external tool that generates header images in your colors. 
License: GPLv2
...
1. Go to the theme customizer (Appearance -> Customize) and adjust the eight new color pickers under the "Colors" heading to your liking
1. If you want to create a header image in your colors, save your changes in the customizer and refresh the page. Then, go to the "Header Image" section and follow the links.

== Screenshots ==
1. Color customization interface within the theme customizer.
2. All eight customizable color blocks (with default colors).
3. Custom header integration, with some generated headers.
